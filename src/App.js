            ...
            for(let i = 0; i<auxCategoria.length;i++){
              ...
              for(let x=0;x<vetorPostsFeedID.length;x++){
                if(auxCategoria[i].nome == vetorPostsFeedID[x]){
                  ...
                  var upar = {}
                  upar[`/posts/categorias/${tipos[o]}/${auxCategoria[i].nome}/`+ mainTitutlo] = {titulo:mainTitutlo,imagem:urlMainImage,id:newKeyPost,sinopse:sinopse,fotos:objFotos,titulos:objTitulos,textos:objTextos}
